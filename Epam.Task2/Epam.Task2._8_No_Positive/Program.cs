...
namespace Epam.Task2._8_No_Positive
{
    ...
    {
        public static int[,,] Generate(int width, int height, int depth, int min, int max)
        {
        ...
        public static void NoPositive(ref int[,,] arr)
        {
            for (int i = 0; i < arr.GetLength(0); i++)
            {
                for (int j = 0; j < arr.GetLength(1); j++)
        ...
        public static void PrintTripleArray(int[,,] arr)
        {
            for (int i = 0; i < arr.GetLength(0); i++)
            {
                for (int j = 0; j < arr.GetLength(1); j++)
